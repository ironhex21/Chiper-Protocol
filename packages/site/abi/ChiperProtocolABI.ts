...
*/
export const ChiperProtocolABI = {
  "abi": [
    {
      "inputs": [],
    ...
    {
      "inputs": [],
      "name": "TooManyActiveRequests",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "WithdrawalNotTimedOut",
      "type": "error"
    },
    {
      "anonymous": false,
